...
namespace ProjectCars.biz.pelecard.ws101 {
    using System;
    ...
    public partial class TrxWs : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public TrxWs() {
            this.Url = global::ProjectCars.Properties.Settings.Default.ProjectCars_biz_pelecard_ws101_TrxWs;
        ...
        public string DebitRegularType(string userName, string password, string termNo, string shopNo, string creditCard, string creditCardDateMmyy, string token, string total, string currency, string cvv2, string id, string authNum, string parmx, string v) {
