        ...
        <div class="row" style="padding-top:110px;" >
            ...
            <div class="Col-sm ">
                <div class="card" style="width: 18rem;">
                    <img src="img/bike1.jpg" class="card-img-top" alt="..." width="350" height="190">
                    <div class="card-body">
                        <h5 class="card-title" style="color: limegreen">במבצע</h5>
                        <p class="card-text shadow p-2 mb-2 bg-white rounded">מכונת התיור ההרפתקני שלפורצת גבולות ומאפשרת לך לצאת למסע ללא מגבלות בטווח הנסיעה, במהירות, בנוחות ובסוג הדרך..</p>
                    </div>
                </div>
            </div>
            <div class="Col-sm">
                <div class="card" style="width: 18rem;">
                    <img src="img/bike2.jpg" class="card-img-top" alt="..." width="350" height="190">
                    <div class="card-body">
                        <h5 class="card-title" style="color: limegreen">במבצע</h5>
                        <p class="card-text shadow p-2 mb-2 bg-white rounded">דגם ה-R מציע את כל מה שיש ב- 890 ADVENTURE S אבל עם אבזור וטכנולוגיה לביצועי שטח הטובים בקטגוריה: מערכת מתלים חדשה לגמרי של WP עם מהלך מתלה של 270 מ”מ עם אפשרות כוונון מלאה, RALLY MODE .</p>
                    </div>
                </div>
            </div>
            <div class="Col-sm">
                <div class="card" style="width: 18rem;">
                    <img src="img/yamaha r1.jpg" class="card-img-top" alt="..." width="350" height="190">
                    <div class="card-body">
                        <h5 class="card-title" style="color: limegreen">במבצע</h5>
                        <p class="card-text shadow p-2 mb-2 bg-white rounded">חישוקים יצוקים המותאמים במיוחד לעיר ולשביל, מערכת בלימה מתקדמת , מערכת ABS של BOSCH עם מצב שטח, טווח של 400 ק”מ בין תדלוקים הודות למנוע חדשני וחסכוני.</p>
                    </div>
                </div>
            </div>
        </div>
